...
int readcommands(FILE *&F,cpu *CPU)
{
    ...
    do
    {
        ...
        case DIV:
        {
            (&(CPU)->coms)->value[3*(CPU)->currcommand]=8;
            break;
        }
        case SQRT:
        {
            (&(CPU)->coms)->value[3*(CPU)->currcommand]=7;
            break;
        }
        case JMP:
        {
            (&(CPU)->coms)->value[3*(CPU)->currcommand]=6;
        ...
        case MUL:
        {
            (&(CPU)->coms)->value[3*(CPU)->currcommand]=5;
            break;
        }
        case ADD:
        {
            (&(CPU)->coms)->value[3*(CPU)->currcommand]=4;
            break;
        }
        case CALL:
        {
            (&(CPU)->coms)->value[3*(CPU)->currcommand]=11;
            fscanf(F,"%lg",&argument);
            (&(CPU)->coms)->value[3*(CPU)->currcommand+1]=(int)argument;
            break;
        }
        case RET:
        {
            (&(CPU)->coms)->value[3*(CPU)->currcommand]=12;
            break;
        }
        case JA:
        {
            (&(CPU)->coms)->value[3*(CPU)->currcommand]=3;
            fscanf(F,"%lg",&argument);
            (&(CPU)->coms)->value[3*(CPU)->currcommand+1]=(int)argument;
        ...
        case POP:
        {
            ...
            if ((c=='\n')||(c==EOF))
            {
                (&(CPU)->coms)->value[3*(CPU)->currcommand]=2;
        ...
        case CRASH:
        {
            (&(CPU)->coms)->value[3*(CPU)->currcommand]=10;
            break;
        }
        case PUSH:
        {
            fscanf(F,"%lg",&argument);
            (&(CPU)->coms)->value[3*(CPU)->currcommand]=1;
            (&(CPU)->coms)->value[3*(CPU)->currcommand+1]=(int)argument;
            if (argument==0)
            {
